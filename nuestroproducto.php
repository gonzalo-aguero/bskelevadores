...
<html lang="es">
<head>
    <title>BSK - Nuestro producto</title>
    <meta charset="UTF-8">
    <meta name="keywords"
    ...
    <link rel="stylesheet" href="css/paginas/nuestroProducto.css">
...
<body>
        ...
        <nav>
            ...
            <div id="div-menu" class="animate__animated animate__fadeIn">
                ...
                <ul class="animate__animated animate__fadeInRightBig">
                    ...
                    <li class="btnIrNuestoProducto" style="color:#f19253">Nuestro producto</li>
    ...
    <section class="portada portadaNuestroProducto">
        <div class="slider">
            <div class="div-portada" style="background-image: url(img/nuestroProducto/portada/1.jpg);"></div>
            <div class="div-portada" style="background-image: url(img/nuestroProducto/portada/2.jpg);"></div>
            <div class="div-portada" style="background-image: url(img/nuestroProducto/portada/3.jpg);"></div>
            <div class="div-portada" style="background-image: url(img/nuestroProducto/portada/4.jpg);"></div>
        </div>
    </section>
    <section id="section-caracteristicasTecnicas">
        <h1>CARACTERÍSTICAS TÉCNICAS</h1>
        <div>
            <div>
                <h2>Pasadizo:</h2>
                <p>Es una estructura compuesta por tramos modulares encastrables en chapa pintada completamente con pintura epoxi horneada en colores a elección. Laterales vidriados panorámicos.</p>
            </div>
            <div>
                <h2>Cabina:</h2>
                <p>Construida sobre una estructura de caños especialmente diseñados, revestido en acero inoxidable terminación pulido mate, con fondo y laterales a elección (medio espejo y medio paño de acero inoxidable o panorámico) estéticamente muy agradables. Piso fabricado en perfilería reforzada con terminación en madera flotante. Construido en chapa pintada, con un spot LED que se enciende desde un interruptor en botonera de cabina.</p>
            </div>
            <div>
                <h2>Botonera de cabina:</h2>
                <p>Botones electrónicos de micro movimiento con led indicador de llamada registrada con selección de piso destino, alarma de emergencia y llave de parada.</p>
            </div>
            <div>
                <h2>Puertas en pisos:</h2>
                <p>De 800mm luz libre x 2000 mm. de altura, construidas con perfiles de aluminio y placas de vidrio de 3mm.</p>
            </div>
            <div>
                <h2>Botoneras de llamada exteriores:</h2>
                <p>Electrónicos de micromovimiento con led indicador de llamada registrada.</p>
            </div>
            <div>
                <h2>Máquina de tracción:</h2>
                <p>Motor de 3HP de alimentación monofásica (220v).</p>
            </div>
            <div>
                <h2>Comandos:</h2>
                <p>24v.</p>
            ...
            <div>
                <h2>Seguridad:</h2>
                <p>Parada de emergencia y alarma acústica en botonera de cabina. Sensor de presencia y trabas mecánicas en todas las puertas de acceso al ascensor. Finales de carrera, sensor de presencia de cabina, sensor de cadena floja y caja de cuñas en techo falso de cabina.</p>
            </div>
        </div>
        <h1>OPCIONALES</h1>
        <div>
            <div>
                <h2>Batería:</h2>
                <p>Permite finalizar el viaje en forma transparente ante un repentino corte del suministro de luz eléctrica.</p>
            </div>
            <div>
                <h2>Puertas de vidrio:</h2>
                <p>Son templadas de 10mm de espesor tipo “blindex”, logrando máxima transparencia.</p>
            </div>
            <div>
                <h2>Revestimiento en acero inoxidable:</h2>
                <p>La estructura exterior se reviste en acero inoxidable logrando una estética sobria ideal para casas de categoría.</p>
            </div>
            <div>
                <h2>Pasamanos tubular:</h2>
                <p>Colocado en la cabina en el panel espejado a 850mm de altura, de acero inoxidable.</p>
            </div>
            <div>
                <h2>Display de cabina:</h2>
                <p>De 3,5” de diagonal full color, con indicador de piso, fecha y hora, con imágenes personalizables.</p>
            </div>
            <div>
                <h2>Barrera infrarroja:</h2>
                <p>Va colocada en la cara abierta de la cabina. El ascensor se detiene si un objeto sobrepasa el plano de la abertura.</p>
            </div>
            <div>
                <h2>Huella digital:</h2>
                <p>El sistema de accionamiento por huella digital permite restringir el uso del ascensor solo a las personas habilitadas. Viene con opción de instalar una llave de habilitación para que lo pueda utilizar alguna visita casual que no tenga huella registrada.</p>
            </div>
            <div>
                <h2>Control Remoto:</h2>
                <p>Para accionamiento a distancia y poder llamar el ascensor desde la comodidad de cualquier lugar de la casa.</p>
            </div>
        </div>
    </section>
