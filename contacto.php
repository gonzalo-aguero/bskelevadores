...
<body>
        ...
        <nav>
            ...
            <div id="div-menu" class="animate__animated animate__fadeIn">
                ...
                <ul class="animate__animated animate__fadeInRightBig">
                    ...
                    <li class="btnIrContacto" style="color:#f19253">Contacto</li>
    ...
    <section class="portadaM2" style="background-image: url(img/cliente.jpg);">
        <div>
            <h1>Contactanos</h1>
        </div>
        <div>
            <h3>Contactate con nosotros y explicanos tu proyecto.</h3>
        </div>
    </section>
    <section id="section-formPresupuesto" class="bgWhite padding10">
        <h1>Contacto</h1>
        <p>Rellená el formulario para que podamos darte un presupuesto adaptado a tus necesidades</p>
        <div>
            <form id="formPresupuesto" action="">
                <label for="nombre2">Nombre <span class="red">*</span></label>
                <input type="text" name="nombre2" id="nombre2" placeholder="Nombre">
                <label for="apellido2">Apellido <span class="red">*</span></label>
                <input type="text" name="apellido2" id="apellido2" placeholder="Apellido">
                <label for="apellido2">e-mail <span class="red">*</span></label>
                <input type="email" name="email2" id="email2" placeholder="Correo electrónico">
                <label for="telefono2">Teléfono <span class="red">*</span></label>
                <input type="tel" name="telefono2" id="telefono2" placeholder="Teléfono fijo o móvil">
                <label for="mensaje2">Comentarios</label>
                <textarea name="mensaje2" id="mensaje2" placeholder="Detalles, especificaciones, etc"></textarea>
                <input type="submit" id="btnEnviar2" class="btnEnviar2" value="Enviar">
    ...
    <script src="js/form/mail2.js"></script>
