    ...
    <div id="div-cargando" class="animate__animated animate__faster">
        ...
        <div id="div-imgCargando">
            <img src="img/logo/logo_resX4_png.png" class="animate__animated animate__slow animate__fadeIn"
                alt="Cargando...">
            <h5>Sitio en desarrollo</h5>
            <p>
                Para consultas sobre la empresa:<br>
                <a href="mailto:bskelevadores@gmail.com">bskelevadores@gmail.com</a><br><br>
                Para consultas sobre el desarrollo de sitios:<br>
                <a href="mailto:gmadesarrolloweb@gmail.com">gmadesarrolloweb@gmail.com</a>
            </p>
        </div>
